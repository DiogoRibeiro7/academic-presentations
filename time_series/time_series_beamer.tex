...
\begin{frame}{Stationarity}
  ...
  \begin{alertbox}{Why Stationarity Matters}
...
\begin{frame}{Seasonal ARIMA}
  \begin{definitionbox}{SARIMA$(p,d,q)(P,D,Q)_s$ Model}
    \begin{equation}
  ...
  \begin{examplebox}{Example: Monthly Sales}
...
\begin{frame}{State Space Representation}
  \begin{definitionbox}{State Space Model}
...
\begin{frame}{Point Forecasts}
  ...
  \begin{examplebox}{AR(1) Forecast}
...
\begin{frame}{Prediction Intervals}
  ...
  \begin{alertbox}{Bootstrap Prediction Intervals}
...
\begin{frame}{Recurrent Neural Networks (RNN)}
  \begin{definitionbox}{RNN Architecture}
    Hidden state update:
    \begin{equation}
