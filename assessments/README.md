...
**Comprehensive evaluation resources for data science courses**
...
4. **Promote Mastery Learning**
   - Formative assessments guide learning
...
**Grading:** See `rubrics/problem_set_rubric.md`
...
**Grading:** See `rubrics/project_rubric.md`
...
4. **`code_quality_rubric.md`**
   - Evaluates code submissions
   - Style, documentation, testing, efficiency
...
4. **Self-Assessment:**
   - Encourage students to use before exams
   - Can be used for class discussion
   - Helps identify common gaps
...
- **Presentations:** `../` (presentation folders)
- **Code Examples:** `../code/`
- **Exercises:** `../exercises/`
