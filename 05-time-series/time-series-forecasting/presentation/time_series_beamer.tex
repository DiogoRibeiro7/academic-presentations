...
\begin{frame}{Common Pitfalls}
  \begin{enumerate}
    \item \textbf{Mis-specifying temporal structure:}
    \begin{itemize}
      \item distinguish deterministic trend, stochastic trend, seasonality, breaks, and time-varying variance;
      \item use unit-root or stationarity tests as evidence within a broader specification analysis, not as automatic preprocessing rules.
    \end{itemize}
