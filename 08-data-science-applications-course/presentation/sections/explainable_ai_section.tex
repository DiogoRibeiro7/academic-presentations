...
\begin{frame}[fragile,allowframebreaks]{Why Interpretability Matters}
...
\textbf{Common but oversimplified view:}
\begin{itemize}
...
\item \textcolor{crimson}{\textbf{Regulatory Compliance}}
   \begin{itemize}
   \item Some decisions require documentation, contestability, human oversight, or other accountability mechanisms
...
\begin{frame}[fragile,allowframebreaks]{Types of Interpretability}
...
\hline
Can exploit internals & Works across many model classes \\
\hline
\end{tabular}
\end{table}
...
\begin{frame}[fragile,allowframebreaks]{Intrinsically Interpretable Models}
