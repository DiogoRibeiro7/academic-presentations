...
\begin{enumerate}
\item \textbf{Install R}: Download from \url{[https://cran.r-project.org/}](https://cran.r-project.org/})
\item \textbf{Install RStudio}: Download from \url{[https://posit.co/products/open-source/rstudio/}](https://posit.co/products/open-source/rstudio/})
...
\end{itemize}
\item Write a function \texttt{grade_analysis()} that:
\begin{itemize}
...
\texttt{ggplot(data, aes(x, y)) + geom_*() + theme() + ...}
\end{frame}
...
\textbf{Books:}
\begin{itemize}
\item "R for Data Science" by Wickham & Grolemund
\item "Advanced R" by Hadley Wickham
\item "R Packages" by Wickham & Bryan
\item "Statistical Learning with R" by James et al.
\end{itemize}

\textbf{Online Resources:}
\begin{itemize}
\item RStudio Education: \url{[https://education.rstudio.com/}](https://education.rstudio.com/})
\item R-bloggers: \url{[https://www.r-bloggers.com/}](https://www.r-bloggers.com/})
\item CRAN Task Views: \url{[https://cran.r-project.org/web/views/}](https://cran.r-project.org/web/views/})
\item R Weekly: \url{[https://rweekly.org/}](https://rweekly.org/})
\end{itemize}
...
\texttt{[dfr@esmad.ipp.pt](mailto:dfr@esmad.ipp.pt)}
