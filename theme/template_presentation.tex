...
\begin{frame}{Academic Integrity}
  ...
  \begin{itemize}
    \item \texttt{bibliographies/mcmc\_references.bib}
    \item \texttt{bibliographies/causal\_inference\_references.bib}
    \item \texttt{bibliographies/statistical\_learning\_references.bib}
  \end{itemize}
\end{frame}
