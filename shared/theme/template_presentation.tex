...
% ================================================================
% Canonical Academic Presentation Template
% ================================================================

% Use the shared Beamer compatibility/helpers package
...
\subtitle{Demonstrating the Canonical Beamer Model}
\date{\today}
...
\begin{frame}{Welcome}
  \begin{itemize}
    \item This template demonstrates the canonical Beamer model
  ...
  \begin{block}{Key Features}
    \begin{itemize}
      \item Canonical Madrid/red presentation shell
...
\begin{frame}[fragile]{Python Code}
  \begin{lstlisting}[style=code, caption=Metropolis-Hastings Implementation]
import numpy as np
...
\begin{frame}{Summary}
  \begin{itemize}
    \item The canonical Beamer model provides professional, consistent styling
    \item Custom environments for theorems, definitions, and examples
  ...
  \begin{block}{Get Started}
    \begin{enumerate}
      ...
      \item Customize presentation metadata as needed
